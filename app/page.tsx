  ...
  return (
    <div className="flex flex-col gap-6 px-[4dvw] py-16">
      ...
      <div className="flex flex-col gap-4">
        ...
        <p>
          There wasn't a <span className="text-xl">point</span> of continuing this... get it? Obser<span className="text-xl">point</span>? No? FUCK! 
          anyways this project was about tracking website uptime and was supposed to be for Quntem.
        </p>
      ...
      <div className="flex flex-col gap-4">
        ...
        <p>
          The app looked as ugly as you (very ugly) and got me demotivated NOOOooOOOOOOooooO also it was a stupid fucking idea. 
          so the app was supposed to be an alternative to the clock app (which nobody uses :skulk:) so like oops 10 hours down the drain
        </p>
        <div className="flex flex-col gap-1 p-4 border-2">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex flex-row gap-2 items-center">
          ...
          <h3 className="text-3xl">UserInfo <span className="text-xl">(formerly UserRate)</span></h3>
        </div>
        <p>
          i couldn't finish this in time for the summer of making "game jam" as other projects had priority idk what you fucking call it. 
          it was originally meant to be tea for hack club but now it's just user information checker!
        </p>
        <div className="flex flex-col gap-1 p-4 border-2">
